        ...
        <table id="dataTable" class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center; width: 30%">Accesorios / Items</th>
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                <td style="font-size: 10px">
                                    PRESENTACION: {{ strtoupper($item->presentation->name) }}
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td style="text-align: center">
                        <table>
                            ...
                            <tr>
                                <th>Stock</th>
                                <td>                              
                                    @if ($item->itemStocks->sum('stock') == 0)
                                        <del style="color: red">{{number_format($item->itemStocks->sum('stock'), 2, ',', '.')}}</del>
                                    @else
                                        {{ number_format($item->itemStocks->sum('stock'), 2, ',', '.') }}
                                    @endif
                                </td>
                            </tr>
                        </table>
